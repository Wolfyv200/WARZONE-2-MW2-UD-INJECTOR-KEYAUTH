...
#define keyAuthOwnerId sk("HIez2GrqcK") 
#define keyAuthProjectName sk("SwapperLite") 
#define keyAuthSecret sk("1c2bd368d59e06082af0f2b757373d005c679b083dee0784216e751b2cf63184")
#define keyAuthVersion sk("1.0") 
#define ToolName sk("Swapper Lite (MW19)") // Enter Tool Name
std::string licenseKey;
std::string username;
std::string password;
api KeyAuthApp(keyAuthProjectName, keyAuthOwnerId, keyAuthSecret, keyAuthVersion);

void DrawLogo() // https://patorjk.com/software/taag/#p=display&f=Graffiti&t=TEST
{
	cout << "\n";
	cout << R"(
...
void SetColor() // https://www.geeksforgeeks.org/how-to-print-colored-text-in-c/ 
{
	system("Color 09");
}
